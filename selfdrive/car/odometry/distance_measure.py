...
WHEEL_DIAMETER = 0.4826 + 0.11*2# 19 * 0.0254 + tire thick * 2 
                ...
                if CAN_data != None:
                    ...
                    if CAN_data.arbitration_id == 641:
                        ...
                        if self.prev_pls_RL != -1 and self.prev_pls_RR != -1:
                            ...
                            # print(diff_enc_cnt_L)
                            dL = math.pi * WHEEL_DIAMETER / ENCODER_RESOLUTION * diff_enc_cnt_L
                            dR = math.pi * WHEEL_DIAMETER / ENCODER_RESOLUTION * diff_enc_cnt_R
                            
                            dist = (dR + dL) / 2
                            # self.str_ang = self.str_ang can signal
                            dth = math.atan((dR - dL) / REAR_TREAD) #+ math.radians(self.str_ang / 13.6) # here is plus alpha ackerman  //// left + right -
                            # print(dth)
