...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp2, cp_cam):
    ...
    # kana modify - aeye custom bsd 
    if self.CP.enableBsm:
      #ret.leftBlindspot = cp.vl["LCA11"]["CF_Lca_IndLeft"] != 0
      #ret.rightBlindspot = cp.vl["LCA11"]["CF_Lca_IndRight"] != 0
      #print("Custom BSD Left : {}".format(int(cp.vl["aeye"]["custom_bsd_left"])))
      #print("Custom BSD Right : {}".format(int(cp.vl["aeye"]["custom_bsd_right"])))
      ret.leftBlindspot = cp.vl["LCA11"]["CF_Lca_IndLeft"] != 0 or cp.vl["aeye"]["custom_bsd_left"] != 0
      ret.rightBlindspot = cp.vl["LCA11"]["CF_Lca_IndRight"] != 0 or cp.vl["aeye"]["custom_bsd_right"] !=0
    else:
  ...
  def get_can_parser(CP):
    ...
    signals = [
      ...
      #kana modify - aeye custom bsd
      ("custom_bsd_left", "aeye", 0),
      ("custom_bsd_right", "aeye", 0),
