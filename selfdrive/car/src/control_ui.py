...
class ControlUI():
    def __init__(self):
        ros = rospy.init_node('control_UI')
        ...
        lon1_button = tk.Button(text="Longitudinal", command=self.lon1_callback)
        lon2_button = tk.Button(text="Longitudinal", command=self.lon2_callback)
