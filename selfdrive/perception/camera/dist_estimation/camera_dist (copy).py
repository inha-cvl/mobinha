                ...
                if (rb_x+lt_x)/2.0 >320 and (rb_x+lt_x)/2.0 <960:
                    ...
                    if point[0]>min_x and point[0]<max_x :
                        ...
                        if point[1]> 446.65:#<11.13
                            ...
                            distance_2 = line_formula((-377/8754),(26581907/875400),point[1])
                            print('11')
                            print("distance")
                            print(distance_2)
                        elif point[1]> 393.05:#<21.09
                            distance_2 = line_formula((-249/1340),(2522601/26800),point[1])                                
                            print('21')
                            print("distance")
                            print(distance_2)
                        elif point[1]> 348.39:#<29.54
                            distance_2 = line_formula((-845/4466),(6090217/63800),point[1])
                            print('29')
                            print("distance")
                            print(distance_2)
                        elif point[1]> 346.6:#<37.25
                            distance_2 = line_formula((-771/179),(5477927/3580),point[1])
                            print('37')
                            print("distance")
                            print(distance_2)

                        elif point[1]> 334.09:#<41.96
                            distance_2 = line_formula((-157/417),(1398989/8340),point[1])
                            print('41')
                            print("distance")
                            print(distance_2)

                        elif point[1]> 330.52:#<50
                            distance_2 = line_formula((-268/119),(2363234/2975),point[1])
                            print('50')
                            print("distance")
                            print(distance_2)

                        elif point[1]> 328.73:#<55.79
                            distance_2 = line_formula((-579/179),(5008027/4475),point[1])
                            print('55')
                            print("distance")
                            print(distance_2)

                        elif point[1]> 325.16:#<59.14
                            distance_2 = line_formula((-335/357),(6502079/17850),point[1])
                            print('59')
                            print("distance")
                            print(distance_2)
