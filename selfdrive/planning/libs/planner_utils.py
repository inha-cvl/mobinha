...
def calculate_v_by_curvature_up(lane_information, ref_v, min_v, cur_v, max_speed_change_rate=1.0): # info, kph, kph, mps
    #lane information -> [1]:forward direction, [3]:curvature
    max_curvature = 600
    min_curvature = 0
    if lane_information[3] < min_curvature:
    ...
    if new_speed > ref_v * KPH_TO_MPS:
        new_speed = ref_v* KPH_TO_MPS
    return new_speed
