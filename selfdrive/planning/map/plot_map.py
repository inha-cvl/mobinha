...
class PathAnalysis:
    def __init__(self, map_name, map_file, base_lla, rotation_angle, mode='save', is_utm=True, route_file=None):
        ...
        self.route_dir = '/home/inha/Documents/catkin_ws/src/mobinha/selfdrive/planning/map/route_generate/'
...
if __name__ == '__main__':
    ...
    route_file = '/home/inha/Documents/catkin_ws/src/mobinha/selfdrive/planning/map/route_generate/kcity_route_4.txt'  # 如果是 'load' 模式，需要提供路径，如 '/workspace/mobinha/selfdrive/planning/map/route_generate/kcity_route_1.txt'

    if map_name == 'songdo':
        base_lla = (37.3888319, 126.6428739, 7.369)
        rotation_angle = 0
        # map_file = '/workspace/mobinha/selfdrive/planning/map/songdo/'
        map_file = '/home/inha/Documents/catkin_ws/src/mobinha/selfdrive/planning/map/songdo/'
        is_utm = False
        ...
        map_file = '/home/inha/Documents/catkin_ws/src/mobinha/selfdrive/planning/map/KCity/'
        is_utm = True
