...
if __name__ == '__main__':
    ...
    mode = mode_list[0] # 或 'load'
    
    route_file = './route_generate/kcity_route_4.txt'  # 如果是 'load' 模式，需要提供路径，如 '/workspace/mobinha/src/mobinha/selfdrive/planning/map/route_generate/kcity_route_1.txt'
