    ...
    def spat(self, data):
        ...
        for sections in data['intersections']:
            ...
            for states in sections['states']:
                ...
                if states['signalGroup'] == 70 and (gps_now.within(self.region_poly[4]) or gps_now.within(self.region_poly[5]) or gps_now.within(self.region_poly[7])):
                ...
                elif states['signalGroup'] == 70 and gps_now.within(self.region_poly[8]):
                    print"signal 70 :",eventstate
                    print"minEndTIme :",timing
                    print(es_int,timing)
                    print(states['movementName'])
