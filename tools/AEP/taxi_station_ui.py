...
def publish_dest1():
    ...
    stop_signal.set() 
    stop_signal.clear()
    threading.Thread(target=repeat_publish_signal, args=(4,)).start()
    # publish_signal(1)
    publish_mode(1)
...
def publish_dest2():
    ...
    stop_signal.set()
    stop_signal.clear()  
    threading.Thread(target=repeat_publish_signal, args=(5,)).start()
    # publish_signal(2)
    publish_mode(1)
...
def publish_dest3():
    ...
    stop_signal.set()  
    stop_signal.clear()
    threading.Thread(target=repeat_publish_signal, args=(6,)).start()
    # publish_signal(3)
    publish_mode(1)
