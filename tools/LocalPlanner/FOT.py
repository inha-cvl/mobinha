...
class Tester():
    def __init__(self):
        ...
        rospy.Subscriber('/object', Marker, self.parse_object)

        self.objects = [[0,0]]

    def parse_object(self, msg):
        self.objects = []
        for i in range(len(msg.points)):
            self.objects.append([msg.points[i].x, msg.points[i].y])
